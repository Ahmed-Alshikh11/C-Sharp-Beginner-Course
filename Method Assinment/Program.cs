...
class Program
{
    static void Main(string[] args)
    {
        ...
        mathOps.PerformMathOperation(35, 30);  // Multiplying 5 by 2, then displaying 10

        // Calling the method using named parameters (for better readability)
        mathOps.PerformMathOperation(firstNumber: 12, secondNumber: 9);  // Multiplying 8 by 2, then displaying 20
    }
}
